...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm fixed-top">
    ...
    <table class="table col-md-8" style="color: azure; font-size: 15px;" id="kumpulan-buku">
        ...
        <?php
            ...
            if ($data->num_rows == 0){echo '<script>alert("Data Tidak Ditemukan");window.location.href="view.php";</script>';}
            foreach($data as $value){
                ...
                <tr>
                    ...
                    <td><button type='button' style='margin-left:-10px' class='btn btn-danger' id='delete' data-id='".$value['Id']."'>delete</button></td>
                </tr>
                ";
            } 
        ?>
            ...
            <div class="modal-content bg-dark">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="modal-footer"><button type="button" onclick="$('#submit').click()">Update</button></div>
                    </div>
                </div>
            </div>
        </div>
